...
if &bg == "dark"
 hi default hlLevel0 ctermfg=brown     guifg=royalblue3
 hi default hlLevel1 ctermfg=Darkblue  guifg=seagreen3
 hi default hlLevel2 ctermfg=darkgray  guifg=darkorchid3
 hi default hlLevel3 ctermfg=darkgreen guifg=firebrick3
 hi default hlLevel4 ctermfg=cyan      guifg=gold
 hi default hlLevel5 ctermfg=green     guifg=slateblue1
 hi default hlLevel6 ctermfg=cyan      guifg=magenta1
 hi default hlLevel7 ctermfg=magenta   guifg=purple1
 hi default hlLevel8 ctermfg=yellow    guifg=orange1
 hi default hlLevel9 ctermfg=green     guifg=yellow1
else
 hi default   hlLevel0 ctermfg=darkgreen   guifg=orange2
 hi default   hlLevel1 ctermfg=blue        guifg=yellow3
 hi default   hlLevel2 ctermfg=darkmagenta guifg=olivedrab4
 hi default   hlLevel3 ctermfg=red         guifg=green4
 hi default   hlLevel4 ctermfg=darkyellow  guifg=paleturquoise3
 hi default   hlLevel5 ctermfg=darkgreen   guifg=deepskyblue4
 hi default   hlLevel6 ctermfg=blue        guifg=darkslateblue
 hi default   hlLevel7 ctermfg=darkmagenta guifg=darkviolet
 hi default   hlLevel8 ctermfg=red         guifg=red3
 hi default   hlLevel9 ctermfg=darkyellow  guifg=orangered3
endif
